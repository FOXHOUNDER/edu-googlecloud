...
async function cancelOrder(reqTimestamp, IdTessera, IdOrdine, IdMotivazione) {
  return new Promise(function(resolve, reject) {
    const tableName = 'ORDINE_CANCELLAZIONE';
    ...
    API_TARGET_TABLE.insert(record)
      .then((data) => {
        ...
        const sqlStatement = `
          CALL ${connection.API_DATASET}.sp_CancellazioneOrdine(
            @v_uuid,
            @v_IdTessera,
            @v_IdOrdine,
            @v_IdMotivazione
